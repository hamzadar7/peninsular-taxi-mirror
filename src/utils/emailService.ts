      ...
      body: JSON.stringify({
        ...
        html_body: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <p>Dear ${name},</p>
            <p>Thank you for choosing Capel Sound Taxi. To complete your booking, please use the verification code below:</p>
            ...
            <p>Best regards,<br>Capel Sound Taxi Team</p>
            <p style="color: #6b7280; font-size: 14px;">Contact: +61 408 202 034</p>
          </div>
        `,
        text_body: `Your Capel Sound Taxi verification code is: ${otp}. This code will expire in 10 minutes.`
      })
    });
