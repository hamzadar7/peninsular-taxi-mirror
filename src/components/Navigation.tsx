        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden lg:flex items-center">
            <a 
              ...
              className="inline-flex items-center gap-2 px-4 py-2 text-yellow-400 hover:text-yellow-300 transition-colors text-sm font-medium bg-yellow-400/10 rounded-md hover:bg-yellow-400/20"
            >
